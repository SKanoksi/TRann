...
Fully connected ANN -> 2 hidden layer
Input argument 1 = Number of nodes of the 1st hidden layer
Input argument 2 = Number of nodes of the 2nd hidden layer
Input argument 3 = Activation function
Input argument 4 = Dataset
"""
...
if len(sys.argv) != 4+1 :
    print('Invalid:: require 4 input arguments, i.e.,  Number of nodes of the two hidden layers, Activation function, TRann experimental point.')
    sys.exit()
...
Shape = [len(colIn),int(sys.argv[1]),int(sys.argv[2]),len(colOut)]
...
filePath = './Result/Stats/' + sys.argv[4] + '_Stats_' + nameOut + '_Dense2.csv'
...
history  = None
annStats = None
filePath = './Result/Weights/' + sys.argv[4] + '_' + sys.argv[1] + '_' + sys.argv[2] + '_' + sys.argv[3] + '_Weights_' + nameOut + '_Dense2.h5'
...
# 6) Save ------------------------------------------------------------
# Plot Train
filePath = './Result/Train/' + sys.argv[4] + '_' + sys.argv[1] + '_' + sys.argv[2] + '_' + sys.argv[3] + '_Train_' + nameOut + '_Dense2.png'
...
# Plot Test
filePath = './Result/Test/' + sys.argv[4] + '_' + sys.argv[1] + '_' + sys.argv[2] + '_' + sys.argv[3] + '_Test1_' + nameOut + '_Dense2.png'
result = test.copy()
...
filePath = './Result/Test/' + sys.argv[4] + '_' + sys.argv[1] + '_' + sys.argv[2] + '_' + sys.argv[3] + '_Test2_' + nameOut + '_Dense2.png'
plt.figure(2)
...
newLog = [int(-1),nameOut + '_Dense2',Shape,Acti,annStats,[stat.loc['mean'][0],stat.loc['std'][0]]]
